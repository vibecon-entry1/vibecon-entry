...
3 hearts. pits cost a heart. 0 hearts = u ded (aliens come back, score gets docked — very fair). beatable in under 4 minutes. your first clear will not be under 4 minutes.
...
every feature ran a two-stage review (spec compliance → code quality) with adversarial verification before merging. the reviews caught 30+ real bugs before any human ever hit them. such process.
